...
{
    public class vwTimekeepingSynthesisMap : EntityTypeConfiguration<vwTimekeepingSynthesis>
    {
        public vwTimekeepingSynthesisMap()
        {
            ...
            this.ToTable("vwStaff_TimekeepingSynthesis");
