...
{
    public class vwPhysicalInventoryMaterialMap : EntityTypeConfiguration<vwPhysicalInventoryMaterial>
    {
        public vwPhysicalInventoryMaterialMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.ToTable("vwSale_PhysicalInventoryMaterial");
