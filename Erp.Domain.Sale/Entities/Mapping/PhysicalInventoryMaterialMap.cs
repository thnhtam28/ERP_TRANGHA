...
{
    public class PhysicalInventoryMaterialMap : EntityTypeConfiguration<PhysicalInventoryMaterial>
    {
        public PhysicalInventoryMaterialMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.ToTable("Sale_PhysicalInventoryMaterial");
