...
{
    public class vwLogPromotionMap : EntityTypeConfiguration<vwLogPromotion>
    {
        public vwLogPromotionMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.ToTable("vwSale_LogPromotion");
            ...
            this.Property(t => t.GiftProductName).HasColumnName("GiftProductName");
            this.Property(t => t.ProductName).HasColumnName("ProductName");
            this.Property(t => t.Category).HasColumnName("Category");
            this.Property(t => t.Note).HasColumnName("Note");
            this.Property(t => t.GiftProductOrigin).HasColumnName("GiftProductOrigin");
            this.Property(t => t.ProductOrigin).HasColumnName("ProductOrigin");
