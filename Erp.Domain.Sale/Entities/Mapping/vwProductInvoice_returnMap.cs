...
{
    public class vwProductInvoice_returnMap : EntityTypeConfiguration<vwProductInvoice_return>
    {
        public vwProductInvoice_returnMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.ToTable("vwSale_ProductInvoice_return");
