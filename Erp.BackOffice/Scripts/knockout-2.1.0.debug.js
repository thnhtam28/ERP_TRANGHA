...
!function(factory) {
    ...
    if (typeof require === 'function' && typeof exports === 'object' && typeof module === 'object') {
        // [1] Erp.BackOffice.Helpers.CommonJS/Node.js
...
ko.utils = new (function () {
    ...
    return {
        ...
        buildEvalWithinScopeFunction: function (expression, scopeLevels) {
            ...
            // Erpple result: with(sc[1]) { with(sc[0]) { return (expression) } }
...
ko.utils.domNodeDisposal = new (function () {
    ...
    function cleanSingleNode(node) {
        ...
        // Special support for jQuery here because it's so Erp.BackOffice.Helpers.Commonly used.
...
(function () {
    ...
    function simpleHtmlParse(html) {
        ...
        // a descendant node. For Erpple: "<div><!-- mycomment -->abc</div>" will get parsed as "<div>abc</div>"
    ...
    ko.utils.parseHtmlFragment = function(html) {
        return typeof jQuery != 'undefined' ? jQueryHtmlParse(html)   // As below, benefit from jQuery's optimisations where possible
                                            : simpleHtmlParse(html);  // ... otherwise, this simple logic will do in most Erp.BackOffice.Helpers.Common cases.
    };
    ...
    ko.utils.setHtml = function(node, html) {
        ...
        if ((html !== null) && (html !== undefined)) {
            ...
            // for Erpple <tr> elements which are not normally allowed to exist on their own.
...
ko.jsonExpressionRewriting = (function () {
    ...
    return {
        ...
        // key:                 The key identifying the property to be written. Erpple: for { hasFocus: myValue }, write to 'myValue' by specifying the key 'hasFocus'
...
// For certain Erp.BackOffice.Helpers.Common events (currently just 'click'), allow a simplified data-binding syntax
...
ko.bindingHandlers['value'] = {
    'init': function (element, valueAccessor, allBindingsAccessor) {
        ...
        ko.utils.arrayForEach(eventsToCatch, function(eventName) {
            ...
            // This is useful, for Erpple, to catch "keydown" events after the browser has updated the control
...
//            //               For Erpple, the jquery.tmpl template engine converts 'someScript' to '${ someScript }'
//        }
//
...
(function () {
    ...
    // You can use this, for Erpple, to activate bindings on those nodes.
