...
{
    public class LogReceiptViewModel
    {
        ...
        [Display(Name = "CodeLogReceipt", ResourceType = typeof(Wording))]
        public string Code { get; set; }
        [Display(Name = "DateReceipt", ResourceType = typeof(Wording))]
        ...
        public decimal? Tongtienxacnhan { get; set; }
        public List<ReceiptViewModel> DetailList { get; set; }
