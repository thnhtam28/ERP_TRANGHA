...
{
    public class PhysicalInventoryMaterialViewModel
    {
        ...
        [Display(Name = "MaterialInboundCode", ResourceType = typeof(Wording))]
        public string MaterialInboundCode { get; set; }

        [Display(Name = "MaterialOutboundCode", ResourceType = typeof(Wording))]
        public string MaterialOutboundCode { get; set; }

        public List<PhysicalInventoryMaterialDetailViewModel> DetailList { get; set; }
    }
}