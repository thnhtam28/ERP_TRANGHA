...
{
    public class ServiceReminderGroupViewModel
    {
        ...
        //[Display(Name = "ServiceReminderId", ResourceType = typeof(Wording))]
        public Nullable<int> ServiceReminderId { get; set; }
        [Display(Name = "ReminderContent", ResourceType = typeof(Wording))]
        public string Name { get; set; }

        [Display(Name = "Reminder", ResourceType = typeof(Wording))]
        public Nullable<bool> Reminder { get; set; }
        [Display(Name = "QuantityDate", ResourceType = typeof(Wording))]
