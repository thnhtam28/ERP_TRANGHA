...
{
    public class vwCRM_Sale_ProductInvoiceDetailMap : EntityTypeConfiguration<vwCRM_Sale_ProductInvoiceDetail>
    {
        public vwCRM_Sale_ProductInvoiceDetailMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.ToTable("vwCRM_Sale_ProductInvoiceDetail");
