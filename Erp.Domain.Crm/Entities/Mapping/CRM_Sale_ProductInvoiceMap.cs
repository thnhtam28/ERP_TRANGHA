...
{
    public class CRM_Sale_ProductInvoiceMap : EntityTypeConfiguration<CRM_Sale_ProductInvoice>
    {
        public CRM_Sale_ProductInvoiceMap()
        {
            this.HasKey(t => t.Id);
            ...
            this.ToTable("CRM_Sale_ProductInvoice");
